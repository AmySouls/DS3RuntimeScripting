...
public:
	...
	*/
	...
	void setNoDamage(bool value);

	bool isNoDead();

	void setNoDead(bool value);

	bool isNoStaminaConsumption();

	void setNoStaminaConsumption(bool value);

	bool isNoFPConsumption();

	void setNoFPConsumption(bool value);
private:
	uintptr_t address;
};
